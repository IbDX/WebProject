...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <body>
        ...
        <p><a href="crud_demo.html">Back to demo</a></p>
    </body>
    </html>
    <?php
    exit;
...
<body>
    ...
    <ul>
        <li>Visit <a href="crud_demo.html">crud_demo.html</a> for an interactive demo.</li>
        <li>AJAX API example: <code>GET /public/crud_handler.php?api=1</code></li>
    </ul>
</body>
</html>
